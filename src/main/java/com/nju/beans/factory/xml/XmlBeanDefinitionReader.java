package com.nju.beans.factory.xml;
...
import com.nju.beans.factory.support.AbstractBeanDefinitionReader;
import com.nju.beans.factory.support.BeanDefinitionRegistry;
            ...
            if (childNodes.item(i) instanceof Element) {
                if (BEAN_ELEMENT.equals(((Element) childNodes.item(i)).getNodeName())) {
                    ...
                    if (StrUtil.isEmpty(beanName)) {
                        // 如果id和name都为空，将类名的第一个字母小写作为bean的名称
